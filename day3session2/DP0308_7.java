package com.learning.core.day3session2;
	...
	public class DP0308_7 {
	    public static void main(String[] args) {
	        ...
	        // Retrieve the key-value mapping associated with the greatest and least price
	        System.out.println("Key-Value Mapping associated with the Greatest and the Least Price:");
	        Map.Entry<Car, Integer> leastEntry = carMap.firstEntry();
	        Map.Entry<Car, Integer> greatestEntry = carMap.lastEntry();
